...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("sticky inset-x-0 top-0 z-40 flex w-full flex-col items-center px-4 pt-4", className)}
    >
    ...
    <motion.div
      ...
      className={cn(
        ...
        visible
          ...
          : "bg-transparent [&_a]:text-white [&_span]:text-white",
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex flex-col items-center justify-between px-0 py-2 lg:hidden",
        visible
          ? "bg-white/80 dark:bg-neutral-950/80 [&_a]:text-neutral-900 [&_svg]:text-black dark:[&_a]:text-white dark:[&_svg]:text-white"
          : "bg-transparent [&_a]:text-white [&_svg]:text-white",
        className,
      )}
    >
      {children}
